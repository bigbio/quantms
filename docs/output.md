...
4. Remove artifacts of open modification search using CrystalC
5. Validate peptide assignment using Philosopher PeptideProhet
6. Bin, map and annotate mass shifts to protein modifications using PTMShepherd
7. Generate a graphical histogram of the binned mass shifts
...
- identification results:
  ...
  - [searchenginemsfragger/\*.idXML\*.pepXML](#identifications)
...
#### Open Modification Search output

If the open modification feature is used, the main results can be found as tabular data in the ptmshepherd directory or additionally as graphical histogram in the deltamasshistogram directory.
All other output files generated by this pipeline are intermediate steps using pepXML or tsv files.
