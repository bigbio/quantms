...
include { ID_SCORE_SWITCHER as IDSCORESWITCHER } from '../../modules/local/openms/idscoreswitcher/main'
include { FALSE_DISCOVERY_RATE as FDRCONSENSUSID } from '../../modules/local/openms/falsediscoveryrate/main'
