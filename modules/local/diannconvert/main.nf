process DIANNCONVERT {
    ...
    conda (params.enable_conda ? "conda-forge::pandas_schema conda-forge::lzstring bioconda::pmultiqc=0.0.18" : null)
    if (workflow.containerEngine == 'singularity' && !params.singularity_pull_docker_container) {
        container "https://depot.galaxyproject.org/singularity/pmultiqc:0.0.18--pyhdfd78af_0"
    } else {
        container "quay.io/biocontainers/pmultiqc:0.0.18--pyhdfd78af_0"
    }
